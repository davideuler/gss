...
public class TopPanel extends Composite {
	...
	public TopPanel(Images images) {
		...
		quitItem.getElement().setId("topMenu.quitMenu");
		...
		fileItem.getElement().setId("topMenu.fileMenu");		
		...
		editItem.getElement().setId("topMenu.editMenu");	
		...
		groupItem.getElement().setId("topMenu.groupMenu");
		...
		configureItem.getElement().setId("topMenu.settingsMenu");
		...
		helpItem.getElement().setId("topMenu.helpMenu");
